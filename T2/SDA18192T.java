...
/**
 * @see Alogaritma Circular linkedList berasal dari https://www.sanfoundry.com/java-program-implement-circular-singly-linked-list/ 
 * @author vikri
 */
...
class linkedList {
    ...
    public int[] searchLoop() {// fungsi pencarian data yang sama di linked list
        Node ptr = start;
        int ukuranLoop = size;
        int counter = 3;
